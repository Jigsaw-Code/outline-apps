...
typedef enum _TAP_MINIPORT_ADAPTER_STATE {
...
} TAP_MINIPORT_ADAPTER_STATE,
    *PTAP_MINIPORT_ADAPTER_STATE;
...
FORCEINLINE
LONG tapAdapterContextReference(__in PTAP_ADAPTER_CONTEXT Adapter) {
...
FORCEINLINE
LONG tapAdapterContextDereference(IN PTAP_ADAPTER_CONTEXT Adapter) {
