...
VOID tapAdapterContextAddToGlobalList(__in PTAP_ADAPTER_CONTEXT Adapter) {
...
PTAP_ADAPTER_CONTEXT
tapAdapterContextFromDeviceObject(__in PDEVICE_OBJECT DeviceObject) {
  LOCK_STATE lockState;
...
NDIS_STATUS
AdapterSetOptions(__in NDIS_HANDLE NdisDriverHandle, __in NDIS_HANDLE DriverContext)
/*++
Routine Description:
...
VOID AdapterHalt(__in NDIS_HANDLE MiniportAdapterContext, __in NDIS_HALT_ACTION HaltAction)
/*++
...
NDIS_STATUS
AdapterPause(__in NDIS_HANDLE MiniportAdapterContext,
...
NDIS_STATUS
AdapterRestart(__in NDIS_HANDLE MiniportAdapterContext,
...
BOOLEAN
tapAdapterReadAndWriteReady(__in PTAP_ADAPTER_CONTEXT Adapter)
/*++
...
NDIS_STATUS
tapAdapterSendAndReceiveReady(__in PTAP_ADAPTER_CONTEXT Adapter)
/*++
...
BOOLEAN
AdapterCheckForHangEx(__in NDIS_HANDLE MiniportAdapterContext)
/*++
...
NDIS_STATUS
AdapterReset(__in NDIS_HANDLE MiniportAdapterContext, __out PBOOLEAN AddressingReset)
/*++
...
VOID AdapterDevicePnpEventNotify(__in NDIS_HANDLE MiniportAdapterContext,
  ...
  /*
     ...
     Adapter); break;
          ...
          case NdisDevicePnPEventPowerProfileChanged:
              ...
              //
              DEBUGP(MP_INFO, "[%p] MPDevicePnpEventNotify:
...
VOID AdapterShutdownEx(__in NDIS_HANDLE MiniportAdapterContext,
...
VOID tapAdapterReleaseLock(__in PTAP_ADAPTER_CONTEXT Adapter, __in BOOLEAN DispatchLevel) {
  ASSERT(!DispatchLevel || (DISPATCH_LEVEL == KeGetCurrentIrql()));
