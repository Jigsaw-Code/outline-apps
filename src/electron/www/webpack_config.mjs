...
import {baseConfig, browserConfig, TS_LOADER, GENERATE_CSS_RTL_LOADER} from './webpack_base.mjs';
import {merge} from 'webpack-merge';
import {getProjectRootDir} from '../../build/get_project_root_dir.mjs';

export default merge(baseConfig, browserConfig, {
  entry: [path.resolve(getProjectRootDir(), 'src', 'electron', 'www', 'main.ts')],
  ...
  plugins: [
    ...
    new HtmlWebpackPlugin({
      filename: 'index.html',
      template: path.resolve(getProjectRootDir(), 'src', 'electron', 'www', 'index.html'),
    }),
  ],
});
