...
echo "stagingPercentage: $STAGING_PERCENTAGE" >> build/dist/beta${MANIFEST_PREFIX}.yml
echo "stagingPercentage: $STAGING_PERCENTAGE" >> build/dist/latest${MANIFEST_PREFIX}.yml
