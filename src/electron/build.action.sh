...
MANIFEST_PREFIX=
[[ "${PLATFORM}" == "linux" ]] && MANIFEST_PREFIX="linux-"

echo "stagingPercentage: $STAGING_PERCENTAGE" >> build/dist/${MANIFEST_PREFIX}beta.yml
echo "stagingPercentage: $STAGING_PERCENTAGE" >> build/dist/${MANIFEST_PREFIX}latest.yml
