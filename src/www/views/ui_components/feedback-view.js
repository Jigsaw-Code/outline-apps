  ...
  _template: html`
    ...
    <paper-card>
      <div class="card-content">
        ...
        <p
          class="info"
          inner-h-t-m-l="[[localize('feedback-privacy', 'privacyPolicyLinkOpen', '<a href=https://s3.amazonaws.com/outline-vpn/index.html#/en/support/dataCollection>', 'privacyPolicyLinkClose', '</a>')]]"
        ></p>
      </div>
