    ...
    <div id="container">
      ...
      <div id="footer-container">
        <div id="footer">
          ...
          <p class="faded" hidden$="[[!isBetaRelease]]">
            Thank you for trying out Outline Beta! Please submit feedback through the app if you experience crashes or
            bugs. Outline Beta uses Google's Firebase service to collect debugging information that can help us detect
            problems and improve Outline. If you do not want Outline to send this information through Firebase, please
            use the production version of the app.
          </p>
          <p class="faded" hidden$="[[isBetaRelease]]">[[localize('privacy-text')]]</p>
