...
module.exports = function(context) {
  ...
  child_process.execSync('cp -R build/third_party/CocoaLumberjack/Carthage/Build/CocoaLumberjack.xcframework plugins/cordova-plugin-outline/apple/lib/ios/');
  child_process.execSync('cp -R build/third_party/CocoaLumberjack/Carthage/Build/CocoaLumberjackSwift.xcframework plugins/cordova-plugin-outline/apple/lib/ios/');
  
  child_process.execSync('echo "Building sentry-cocoa" && cd third_party/sentry-cocoa && make');
  child_process.execSync('cp -R build/third_party/sentry-cocoa/Carthage/Build/Sentry.xcframework plugins/cordova-plugin-outline/apple/lib/ios/');
