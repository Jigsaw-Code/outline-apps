...
// SessionConfig specifies the parameters for a VPN session.
export interface SessionConfig {
  // Config for the transport to be used.
  // TODO(fortuna): make this an opaque string.
...
export interface VpnApi {
  ...
  start(id: string, name: string, config: SessionConfig): Promise<void>;
