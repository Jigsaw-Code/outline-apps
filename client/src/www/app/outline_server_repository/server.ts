...
import {fetchShadowsocksSessionConfig, staticKeyToSessionConfig} from './access_key_serialization';
import * as errors from '../../model/errors';
import * as events from '../../model/events';
import {PlatformError} from '../../model/platform_error';
import {Server, ServerType} from '../../model/server';
import { SessionConfig, TunnelStatus, VpnApi } from './vpn';
...
export class OutlineServer implements Server {
  ...
  get address() {
    ...
    return `${this.sessionConfig.transport.host}:${this.sessionConfig.transport.port}`;
  }
