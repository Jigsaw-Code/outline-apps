...
public class OutlinePlugin extends CordovaPlugin {
    ...
    cordova.getThreadPool().execute(() -> {
      try {
        ...
        // Tunnel instance actions: tunnel ID is always the first argument.
          ...
          final String usageReportConfig = args.getString(3);
          sendActionResult(callback, startVpnTunnel(tunnelId, transportConfig, usageReportConfig, serverName));
  ...
  private DetailedJsonError startVpnTunnel(
      final String tunnelId, final String transportConfig, final String usageReportConfig, final String serverName
    ...
    tunnelConfig.usageReportConfig = usageReportConfig;
