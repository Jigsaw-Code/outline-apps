...
readonly OUT_DIR="${BUILD_DIR}/server_manager/install_scripts/"
rm -rf "${OUT_DIR}"
...
node server_manager/install_scripts/build_do_install_script_ts.node.js \
    "${BUILD_DIR}/server_manager/install_scripts/do_scripts.tgz" > "${BUILD_DIR}/server_manager/install_scripts/do_install_script.ts"
node server_manager/install_scripts/build_gcp_install_script_ts.node.js \
    "${BUILD_DIR}/server_manager/install_scripts/gcp_scripts.tgz" > "${BUILD_DIR}/server_manager/install_scripts/gcp_install_script.ts"
popd > /dev/null
