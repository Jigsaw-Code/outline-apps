...
node server_manager/install_scripts/build_do_install_script_ts.node.js \
    "${BUILD_DIR}/server_manager/web_app/sh/do_scripts.tgz" > "${ROOT_DIR}/server_manager/install_scripts/do_install_script.ts"
node server_manager/install_scripts/build_gcp_install_script_ts.node.js \
    "${BUILD_DIR}/server_manager/web_app/sh/gcp_scripts.tgz" > "${ROOT_DIR}/server_manager/install_scripts/gcp_install_script.ts"
popd > /dev/null
