...
!macro customInstall
  ...
  ${EndIf}
  SetOutPath -
  File "${PROJECT_DIR}\apps/client\electron\add_tap_device.bat"
  File "${PROJECT_DIR}\apps/client\electron\find_tap_device_name.bat"
  ...
  File "${PROJECT_DIR}\apps/client\electron\install_windows_service.bat"
