...
export async function main(...parameters) {
  ...
  if (outlinePlatform === 'macos' || outlinePlatform === 'ios') {
    const WORKSPACE_PATH = `${process.env.ROOT_DIR}/apps/client/cordova/apple/${outlinePlatform}.xcworkspace`;
  ...
  if (cordovaPlatform === 'android') {
    let argv = [
      ...
      '--gradleArg=--include-build=../../apps/client/cordova/android/OutlineAndroidLib',
    ];
    if (verbose) {
