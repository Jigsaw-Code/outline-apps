...
for TRANSLATION_FILE in "$TRANSLATIONS_DIR/*"; do
  ...
  NATIVE_DIR="apps/client/cordova/plugin/android/resources/strings/values-$LANG"
  OUTPUT_FILE="$NATIVE_DIR/strings.xml"
  python3 "$ROOT_DIR/apps/client/cordova/android/import_messages.py" $TRANSLATION_FILE $OUTPUT_FILE
done
