...
export async function main(...parameters) {
  ...
  if (isApple) {
    ...
    // rsync -avc --existing platforms/ios/ apps/client/cordova/apple/xcode/ios/
    // or
    // rsync -avc --existing platforms/osx/ apps/client/cordova/apple/xcode/macos/
    // TODO(daniellacosse): move this to a cordova hook
    execSync(`rsync -avc apps/client/cordova/apple/xcode/${outlinePlatform}/ platforms/${cordovaPlatform}/`, {
      stdio: 'inherit',
    });
  }
}
